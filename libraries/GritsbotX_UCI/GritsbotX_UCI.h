#ifndef GritsbotX_UCI_h
#define GritsbotX_UCI_h
...
class GritsbotX
{
  ...
  private:
    ...
    static constexpr uint8_t _IRLF = A8;// A0 // Analog input pin for left forward distance sensor
    ...
    static constexpr uint8_t _enIRF = 23; // D28 // Digital enable output pin for forward distance sensor
    ...
    static constexpr uint8_t _enIRRB = 7;// D24 // Digital enable output pin for left back distance sensor
    static constexpr uint8_t _enIRR = 8;// D25 // Digital enable output pin for right distance sensor
    static constexpr uint8_t _enIRRF = 27;// D27 // Digital enable output pin for right forward distance sensor
    static constexpr uint8_t _enRPi = 12; // Raspberry Pi enable

    //Motor control pins

    static constexpr uint8_t _PWMR = 9;// D4 // Right Motor PWM Control
    static constexpr uint8_t _PWML = 10;// D23 // Left Motor PWM Control
    ...
    static constexpr uint8_t _RMotor1 = 3;// D0 // Right Motor Direction 1
    static constexpr uint8_t _RMotor2 = 4;// D1 // Right Motor Direction 2

    //static constexpr uint8_t _LMotor1 = 24;// D7 // Left Motor Direction 1
    //static constexpr uint8_t _LMotor2 = 25;// D8 // Left Motor Direction 2
    static constexpr uint8_t _LMotor1 = 21;// D7 // Left Motor Direction 1
    static constexpr uint8_t _LMotor2 = 22;// D8 // Left Motor Direction 2

    //Encoder feedback pins

    static constexpr uint8_t _interruptL1 = 17;// D20 // Left motor encoder interrupt 1
    static constexpr uint8_t _interruptR1 = 7;// D2 // Right motor encoder interrupt 1

    static constexpr uint8_t _interruptL2 = 18;// D21 // Left motor encoder interrupt 2
    static constexpr uint8_t _interruptR2 = 8;// D3 // Right motor encoder interrupt 2

    //Battery feedback pins

    static constexpr uint8_t _battVoltage = A0;// A8 // Analog battery voltage measurement
